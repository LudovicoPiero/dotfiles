...
in
{
  ...
  config = mkIf cfg.enable {
    hj.rum.programs.ncmpcpp = {
      ...
      settings = {
        # Miscelaneous
        ncmpcpp_directory = "${config.vars.homeDirectory}/.config/ncmpcpp";

        mpd_host = "localhost";
        mpd_port = "6600";
        mpd_music_dir = "${config.vars.homeDirectory}/Media/Music";
        ...
        # GENERAL
        # ---
        lyrics_directory = "${config.vars.homeDirectory}/.config/ncmpcpp/lyrics";
