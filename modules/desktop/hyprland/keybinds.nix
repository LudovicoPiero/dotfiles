...
in
{
  config = mkIf cfg.enable {
    hj.xdg.config.files."hypr/lua/keybinds.lua".text = ''
      ...
      hl.bind(mod .. " + P", hl.dsp.exec_cmd("noctalia msg panel-toggle launcher"))
      hl.bind(mod .. " + SHIFT + P", hl.dsp.exec_cmd("noctalia msg window-switcher"))

      hl.bind(mod .. " + O", hl.dsp.exec_cmd("noctalia msg panel-toggle clipboard"))
      ...
      hl.bind(mod .. " + X", hl.dsp.exec_cmd("noctalia msg panel-toggle control-center"))
      hl.bind(mod .. " + W", hl.dsp.window.close())
      hl.bind(mod .. " + SHIFT + C", hl.dsp.exec_cmd("noctalia msg session logout"))
