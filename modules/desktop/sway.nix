  ...
  config = mkIf cfg.enable {
    ...
    hj = {
      ...
      xdg.config.files."sway/config".text = ''
        ...
        bindsym Mod4+Return exec ${getExe pkgs.${config.mine.vars.terminal}}
        ...
        for_window [class="^steam$" title="^Steam - News$"] floating enable, focus disable
        for_window [class="^steam$" title="(?i)^notificationtoasts"] focus disable
        for_window [class="^steam$" title="^$"] focus disable
        for_window [class="^foobar2000.exe$"] move to workspace number 1, floating disable
        for_window [app_id="(?i)(firefox|firefox-esr|floorp|zen|zen-beta|zen-browser|brave-browser|chromium-browser|google-chrome|chrome)"] move to workspace number 2
        for_window [class="(?i)(firefox|firefox-esr|floorp|zen|zen-beta|zen-browser|brave-browser|chromium-browser|google-chrome|chrome)"] move to workspace number 2
        for_window [app_id="(?i)(firefox|firefox-esr|floorp|zen|zen-beta|zen-browser|brave-browser|chromium-browser|google-chrome|chrome)" title="(?i)youtube"] inhibit_idle focus
        for_window [class="(?i)(firefox|firefox-esr|floorp|zen|zen-beta|zen-browser|brave-browser|chromium-browser|google-chrome|chrome)" title="(?i)youtube"] inhibit_idle focus
        for_window [app_id="(?i)(firefox|firefox-esr|floorp|zen|zen-beta|zen-browser|brave-browser|chromium-browser|google-chrome|chrome)"] inhibit_idle fullscreen
        for_window [class="(?i)(firefox|firefox-esr|floorp|zen|zen-beta|zen-browser|brave-browser|chromium-browser|google-chrome|chrome)"] inhibit_idle fullscreen
        for_window [title="(?i).*(disc|armc|webc)ord.*"] move to workspace number 3
        ...
        for_window [app_id="(?i)^(thunderbird|org.mozilla.thunderbird|net.thunderbird.Thunderbird)$"] move to workspace number 5
        for_window [class="(?i)^(thunderbird|org.mozilla.thunderbird|net.thunderbird.Thunderbird)$"] move to workspace number 5
        for_window [app_id="(?i)^(qbittorrent|org.qbittorrent.qbittorrent)$"] move to workspace number 4
        for_window [class="(?i)^(qbittorrent|org.qbittorrent.qbittorrent)$"] move to workspace number 4
