{
  ...
  wayland.windowManager.hyprland = {
    ...
    extraConfig = ''
         ...
         windowrulev2 = opacity 0.95 , class:^(code-url-handler)$ # VSCODE
         windowrulev2 = rounding 0 , class:^(code-url-handler)$ # VSCODE
        ...
        exec-once = systemctl --user start eww; eww open bar
