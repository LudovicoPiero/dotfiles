_: {
  mine.programs.zen-browser.profiles.ludovico.settings = {
    ...
    "network.trr.default_provider_uri" = "https://dns.nextdns.io/518d18/nixos-zen";
    "network.trr.uri" = "https://dns.nextdns.io/518d18/nixos-zen";
    "network.trr.custom_uri" = "https://dns.nextdns.io/518d18/nixos-zen";
