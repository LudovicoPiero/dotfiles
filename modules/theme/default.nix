      ...
      { config, osConfig, ... }:
      {
        ...
        dconf.settings = {
          "org/gnome/desktop/interface" = {
            ...
            document-font-name = "${osConfig.mine.fonts.terminal.name} ${toString osConfig.mine.fonts.size}";
            monospace-font-name = "${osConfig.mine.fonts.terminal.name} ${toString osConfig.mine.fonts.size}";
            clock-format = "12h";
