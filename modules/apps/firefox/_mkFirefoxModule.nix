...
let
  ...
  mkUserJs =
    ...
    in
    ''
      // Generated by `mine.programs.firefox`.
  ...
  bookmarkTypes = import ./profiles/_bookmark-types.nix { inherit lib; };
in
{
  options = setAttrByPath modulePath {
    ...
    configPath = mkOption {
      ...
      description = "Directory containing the ${appName} configuration files. Defaults to the XDG config home on Linux.";
    };
                ...
                type =
                  types.coercedTo bookmarkTypes.settingsType
                    ...
                    (
                      types.submodule (
                        { config, ... }:
                        import ./profiles/_bookmarks.nix {
