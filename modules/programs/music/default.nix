...
in
{
  ...
  config = mkIf cfg.enable {
    ...
    hj = {
      ...
      # Source: https://github.com/ericmckevitt/rmpc-config
      xdg.config.files = {
        # Config.ron
        "rmpc/config.ron".text = ''
          ...
          (
              ...
              lyrics_dir: Some("${config.hj.xdg.config.directory}/rmpc/lyrics"),
              password: None,
        ...
        # catppuccin_mocha.ron
        "rmpc/themes/catppuccin_mocha.ron".text = ''
          #![enable(implicit_some)]
          #![enable(unwrap_newtypes)]
          #![enable(unwrap_variant_newtypes)]
          (
