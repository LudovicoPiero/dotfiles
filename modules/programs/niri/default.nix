...
in
{
  ...
  config = mkIf cfg.enable {
    environment.etc."greetd/environments".text = lib.mkAfter "niri";
      ...
      programs.niri = {
        ...
        config = [
          ...
          (plain "cursor" [
            ...
            (leaf "xcursor-theme" "${cfgmine.theme.gtk.cursorTheme.name}")
            (leaf "xcursor-size" cfgmine.theme.gtk.cursorTheme.size)
          ])
