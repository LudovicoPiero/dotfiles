...
return {
  ...
  },
  {
    ...
    before = function()
      ...
      LZN.trigger_load("blink.compat")
      LZN.trigger_load("blink-copilot")
      ...
      require("blink.cmp").setup({
        ...
        sources = {
          ...
          providers = {
            ...
            lsp = { score_offset = 4 },
            snippets = { score_offset = 4, opts = { use_show_condition = true, show_autosnippets = true } },
            path = {
              score_offset = 3,
              opts = {
                trailing_slash = true,
            ...
            copilot = { enabled = true, name = "copilot", module = "blink-copilot", score_offset = 100, async = true },
          },
        },
