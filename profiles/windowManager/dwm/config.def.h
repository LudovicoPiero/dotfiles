...
#if BAR_PANGO_PATCH
static const char font[]                 = "Iosevka Nerd Font 10";
#else
...
static char titleselbgcolor[]            = "#1E1E2D";
static char titleselbordercolor[]        = "#1E1E2D";
...
static char tagsselbgcolor[]             = "#db8fd9";
static char tagsselbordercolor[]         = "#1E1E2D";
...
static const Key keys[] = {
  ...
  {MODKEY,                            XK_x,       spawn,        SHCMD("$HOME/.bin/powermenu")},

	#if KEYMODES_PATCH
	{ MODKEY,                       XK_Escape,     setkeymode,             {.ui = COMMANDMODE} },
	#endif // KEYMODES_PATCH
	{ MODKEY,                       XK_p,          spawn,                  {.v = dmenucmd } },
	// { MODKEY,                       XK_p,          spawn,                  SHCMD("$HOME/.bin/rofi") },
